...
sealed class PreferenceImpl<T>(
    ...
    class StringPrimitive(
        ...
        key: String,
        defaultValue: String,
    ) : PreferenceImpl<String>(preferences, keyFlow, key, defaultValue) {
        override fun read(
            preferences: SharedPreferences,
            key: String,
            defaultValue: String,
    ...
    class LongPrimitive(
        ...
        key: String,
        defaultValue: Long,
    ) : PreferenceImpl<Long>(preferences, keyFlow, key, defaultValue) {
    ...
    class IntPrimitive(
        ...
        key: String,
        defaultValue: Int,
    ) : PreferenceImpl<Int>(preferences, keyFlow, key, defaultValue) {
    ...
    class FloatPrimitive(
        ...
        key: String,
        defaultValue: Float,
    ) : PreferenceImpl<Float>(preferences, keyFlow, key, defaultValue) {
    ...
    ) : PreferenceImpl<Boolean>(preferences, keyFlow, key, defaultValue) {
        override fun read(
            preferences: SharedPreferences,
            key: String,
            defaultValue: Boolean,
    ...
    ) : PreferenceImpl<Set<String>>(preferences, keyFlow, key, defaultValue) {
        override fun read(
            preferences: SharedPreferences,
            key: String,
            defaultValue: Set<String>,
    ...
    ) : PreferenceImpl<T>(preferences, keyFlow, key, defaultValue) {
